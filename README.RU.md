# Руководство по патчу CMP50HX 610.43.03

Этот файл — рабочая запись о четырёх патчах в этом каталоге. В нём описаны
цепочка выполнения, причина каждого изменения, подтверждающие проверки и
...
новых ошибок PCIe/AER. См. README пакета
[README](../README.md) и указанную выше матрицу производительности.
...
См. [`build.sh`](../build.sh), README пакета [`README.md`](../README.md) и
корневой файл [`docs/CMP50HX.md`](../../../docs/CMP50HX.md), где описаны
