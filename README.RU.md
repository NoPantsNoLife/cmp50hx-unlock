...
фрагмента, патч 04 — 1 файл и 3 фрагмента, патч 05 — 1 файл и 1 фрагмент.
Патч 05 — это защищённая по BDF подготовка политики CMP50 для native
P-State; она не доказывает автоматический выбор состояния на простое/нагрузку.
Пока не получен чистый native idle/load/idle результат, доказанным обходным
путём остаётся отдельный idle governor. Старый монолитный патч и эта
упорядоченная серия изменяют одни и те же восемь исходных файлов, а патч 05
добавляет подготовку registry.
