# CMP 90HX stockflow candidate builder (variant table probe0..rejoin16).
# Vendored from github.com/jdowning100/cmpunlocker (GPL-2.0), which builds on
# the pearlfortune/cmpunlocker v0.1.28 90hx-stockflow bundle. Unmodified logic.
#!/usr/bin/env bash
set -Eeuo pipefail
